...
impl CatalogCommands {
    ...
    pub async fn mark_book_copy_lost(&self, book_copy: BookCopy) -> anyhow::Result<BookCopy> {
        ...
        self.change_book_copy_status(
            book_copy,
            BookCopyStatus::Lost,
            "Failed to mark book copy lost",
        )
        .await
    }
    ...
    pub async fn mark_book_copy_found(&self, book_copy: BookCopy) -> anyhow::Result<BookCopy> {
        anyhow::ensure!(
            book_copy.can_be_returned_from_lost(),
            BookCopyError::CannotBeReturnedFromLost
        );
        self.change_book_copy_status(
            book_copy,
            BookCopyStatus::Active,
            "Failed to mark book copy found",
        )
        .await
    }
    ...
    pub async fn send_book_copy_to_maintenance(
        ...
        anyhow::ensure!(
            book_copy.can_be_sent_to_maintenance(),
    ...
    pub async fn complete_book_copy_maintenance(
        ...
        anyhow::ensure!(
            book_copy.can_be_returned_from_maintenance(),
